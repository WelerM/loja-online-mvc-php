...
- Create a folder inside "htdocs" from XAMPP, it's recomended to name it as "loja" so you won't have to update the "APP_BASE_URL" and "APP_DOCUMENT_ROOT" enviroment variables inside config.php.
